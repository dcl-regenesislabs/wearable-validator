...
| `packages/debug-ui` | the website: upload → per-check results with plain explanations, concrete how-to-fix steps, exact-section docs links, and a live 3D preview |
